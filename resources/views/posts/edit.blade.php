...
<div class="card card-custom">
    ...
    <form class="form" id="form_post" action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        @csrf
        @method('PUT')
        <div class="card-body">
            @include('posts._form')
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type="submit" id="button_submit" class="btn btn-primary font-weight-bold mr-2">Update</button>
                </div>
            </div>
        </div>
    </form>
