...
(function ($) {
    ...
    */      
    $.fn.editableform.template = '<form class="form-horizontal editableform" autocomplete="off">'+
    '<div class="control-group">' + 
    '<div><div class="editable-input" style="width:375px"></div><div class="editable-buttons"></div></div>'+
